...
public:
    ...
    LGFX(void)
    {
        { // バス制御の設定を行います。
            ...
            cfg.pin_sclk    = 17;       // SCL
            cfg.pin_io0     = 13;       // DIN_SDA_DUAL(QSPI_DIN1)
            cfg.pin_io1     = 18;       // DIN_SDA(QSPI_DIN0)
            cfg.pin_io2     = 21;       // VSYNC_QSPI_DIN2(QSPI_DIN2)
            cfg.pin_io3     = 14;       // DE_QSPI_DIN3
            // cfg.pin_dc      = -1;
        ...
        { // 表示パネル制御の設定を行います。
            ...
            cfg.panel_width      =   640;  // 実際に表示可能な幅
            cfg.panel_height     =   180;  // 実際に表示可能な高さ
